...
public abstract class ShakePreset
{
    ...
    public SpatialAttenuation SpatialAttenuation = new();
    ...
    /// </summary>
    public float MaxDuration { get; private set; } = 1.0f;

    /// <summary>
    ///     If true the shake by this preset is being applied
    /// </summary>
    public bool IsActive => duration > 0.0f;

    public Envelope Envelope { get; protected set; } = new();
